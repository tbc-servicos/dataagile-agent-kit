...
Get your key at [dataagile-agent-kit.dataagile.com.br](https://dataagile-agent-kit.dataagile.com.br).

**Step 3 — Verify** (ask the AI):

```
Liste os plugins instalados e confirme que o dataagile está ativo.
```

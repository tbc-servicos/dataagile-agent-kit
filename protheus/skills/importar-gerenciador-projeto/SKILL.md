...
**Respostas possíveis:**
- `200` — importado com sucesso
  - Modo normal: `"cMensagem": "Projeto importado com sucesso."`
  - Modo incremental: `"cMensagem": "Projeto atualizado incrementalmente com sucesso."` + campos `nRegistrosNovos` e `nRegistrosAtualizados`
...
> **`X3_PICBRV` não incluir no JSON** — o servidor sempre insere vazio, independente do que for enviado. A coluna existe no banco mas não é lida do payload.

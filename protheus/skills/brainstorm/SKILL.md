...
- Identificar se já existe função/PE padrão que resolve o caso
- Evitar reescrever o que já existe nos fontes padrão
- Embasar as abordagens propostas no Passo 3 com evidências do banco

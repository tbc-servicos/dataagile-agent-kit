...
1. Nome do cliente/projeto (ex: CASSI, Bradesco)
2. Host do AppServer (ex: srv1234567.totvs.com.br ou IP)
3. Porta do AppServer (ex: 1234)
4. Nome do Environment/Ambiente (ex: P12, CASSI_PROD)
...
> Solicite ao administrador que cadastre o email em https://mcp.totvstbc.com.br/admin
